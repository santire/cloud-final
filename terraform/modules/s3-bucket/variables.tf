...
variable "server_side_encryptions" {
  type        = bool
  default     = true
  description = "Applies AES256 server side encryption on bucket"
}
...
variable "index_document" {
  type        = string
  description = "Index document if the bucket is a static website"
  default     = null
}

variable "error_document" {
  type        = string
  description = "Error document if the bucket is a static website"
  default     = null
}
...
variable "public_read_policy" {
  type        = bool
  description = "Set to true to apply a public policy"
  default     = false
}
